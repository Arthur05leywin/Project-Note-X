...
base_dir = r'c:\Users\sayan\Downloads\biochem Note X\modules\module-09'
files = [
    'module09_clinical_biochemistry.html',
    'module09_clinical_biochemistry_X.html'
]
    ...
    for card in soup.find_all('div', class_='card'):
        ...
        if title and 'High-Yield Quickfire' in title.text:
           ...
           if table:
               ...
               title_bar.string = "🔥 Exam Day High-Yield Quickfire — Module 09"
