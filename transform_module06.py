...
base_dir = r'modules/module-06'
files = [
    'module06_molecular_biology.html',
    'module06_molecular_biology_X.html'
]
...
for filename in files:
    ...
    if hero and not hero.find('div', class_='brand-container'):
        ...
        # Insert at the very beginning of the hero container
    ...
    for card in soup.find_all('div', class_='card'):
        ...
        if title and 'High-Yield Quickfire' in title.text:
           ...
           if table:
               ...
               title_bar.string = "🔥 Exam Day High-Yield Quickfire — Module 06"
