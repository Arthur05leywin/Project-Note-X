...
base_dir = r'c:\Users\sayan\Downloads\biochem Note X\modules\module-08'
files = [
    'module08_nutrition_vitamins.html',
    'module08_nutrition_vitamins_X.html'
]
    ...
    for card in soup.find_all('div', class_='card'):
        ...
        if title and 'High-Yield Quickfire' in title.text:
           ...
           if table:
               ...
               title_bar.string = "🔥 Exam Day High-Yield Quickfire — Module 08"
