...
base_dir = r'c:\Users\sayan\Downloads\biochem Note X\modules\module-10'
files = [
    'module10_immunochemistry_oncogenesis.html',
    'module10_immunochemistry_oncogenesis_X.html'
]
    ...
    for card in soup.find_all('div', class_='card'):
        ...
        if title and 'High-Yield Quickfire' in title.text:
           ...
           if table:
               ...
               title_bar.string = "🔥 Exam Day High-Yield Quickfire — Module 10"
