...
base_dir = r'modules/module-05'
files = [
    'module05_nucleotide_metabolism.html',
    'module05_nucleotide_metabolism_X.html'
]
  ...
  * { color: #000000 !important; background: transparent !important; box-shadow: none !important; text-shadow: none !important; }
  ...
  details::details-content { display: block !important; }
    ...
    if s8:
        table = s8.find('table')
        if table:
            # Check if drugs are already present to avoid duplication
            if 'Mycophenolate' not in str(table):
        ...
        <td>Organ transplant, Hepatitis C</td>
            ...
            if 'Hydroxyurea' not in str(table):
